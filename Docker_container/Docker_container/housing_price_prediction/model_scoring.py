...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        "-m", "--models", type=str, default="data/models/", help="Directory where the models are stored.",
    )

    parser.add_argument(
        "-d", "--dataset", type=str, default="data/processed/housing_test.csv", help="Path to test dataset csv file.",
    )
...
def score_model(model: sklearn.base.BaseEstimator, X: pd.DataFrame, y: pd.Series, args: Namespace,) -> dict:
    scores = {}
